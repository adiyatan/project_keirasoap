    ...
    <div class="container">
      <main>
        <div class="py-5 text-center">
          <img class="d-block mx-auto mb-4" src="../asset/img/Adiyatan.png" width="100" height="100">
          <h2>Check Pesanan</h2>
          <p class="lead">Kami akan memproses pesanan saat sudah +5 Jam dari pesanan di buat,untuk membatalkan pesanan Silahkan hubungi
            <span><a href="https://wa.me/6282115914639/?text=Halo!%0ASaya%20ingin%20membatalkan%20pesanan%20Apakah%20Bisa" target="_blank">Admin</a></span>. Jika lebih dari ketentuan, pesanan tidak akan dibatalkan
          </p>
        </div>
