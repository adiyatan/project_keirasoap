...
<body>
  <div class="panel_login">
    ...
    <form action="" method="post">
      ...
      <div class="form-floating mb-5">
        <input type="password" class="form-control fs-5" id="floatingInput" placeholder="Confirm Password" name="password2" style="height: 50px" required autocomplete="off">
        <label for="floatingInput">Confirm Password:</label>
      </div>

      <p style="margin-right: 130px; margin-top: -20px;">Already have an account? <a href="login.php" style="color: #00a4a9; font-weight: bold;">Login</a>
      </p>
